...
const query = value => ({ lean: async () => value, select() { return this; }, sort() { return this; }, populate: async () => value, then(resolve, reject) { return Promise.resolve(value).then(resolve, reject); } });
