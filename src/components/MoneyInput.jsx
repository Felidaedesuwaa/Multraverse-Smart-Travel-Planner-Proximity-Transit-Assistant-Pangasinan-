...
export default function MoneyInput({ value, onChangeText, ...props }) {
  ...
  return <TextInput {...props} style={themeStyle(props.style)} placeholderTextColor={themeColor(props.placeholderTextColor || "#6B7876")} accessibilityLabel={props.accessibilityLabel || `Amount in ${currency}`} keyboardType="decimal-pad" value={draft}
